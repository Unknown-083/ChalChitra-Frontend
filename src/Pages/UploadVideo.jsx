  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (error.code === "ECONNABORTED") {
        errorMessage =
          "Upload timeout. The request took too long. Please try with a smaller file.";
                    ...
                    <div className="border-2 border-dashed rounded-xl p-8 sm:p-12 md:p-16 text-center border-[#272727] bg-[#1a1a1a]">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-400 text-xs sm:text-sm">
                          Please wait while we validate your video
                        </p>
                      </div>
                    </div>
                  ) : (
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-white mb-1 truncate text-sm">
